...
My goal is that this in-house book will grow into a commonly used resource that can be updated with new information. I also hope that we move away from word-documents and publish these notes in this book, with version control. I have labelled the version `v.1.1.0`. For more please see the github repository [here](https://github.com/R-LadiesMelbourne/R_Ladies_Melb_Guide).
